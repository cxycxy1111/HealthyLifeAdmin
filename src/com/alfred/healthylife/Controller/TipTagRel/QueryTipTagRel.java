...
@WebServlet(name = "QueryTipTagRel", urlPatterns = "/tiptagrel/query")
public class QueryTipTagRel extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(tipTagRelService.queryByTipId(tip_id));
    }
