...
@WebServlet(name = "QueryTag", urlPatterns = "/tag/query")
public class QueryTag extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        long id = Util.getLongFromRequest(request, "tag_id");
        TagService tagService = new TagService();
        out.append(tagService.query(id));
    }
