...
@WebServlet(name = "QueryUsers",urlPatterns = "/user/queryList")
public class QueryUsers extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(userService.query(del,locked,page_no,num_lmt));
    }
