...
@WebServlet(name = "LockUser",urlPatterns = "/user/lock")
public class LockUser extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(userService.lock(user_id,current_user,Util.getCurrentTime()));
    }
