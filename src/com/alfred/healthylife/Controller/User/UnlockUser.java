...
@WebServlet(name = "UnlockUser",urlPatterns = "/user/unlock")
public class UnlockUser extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(userService.unlock(user_id,current_user,Util.getCurrentTime()));
    }
