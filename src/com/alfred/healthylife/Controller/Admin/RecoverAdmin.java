...
@WebServlet(name = "RecoverAdmin",urlPatterns = "/admin/recover")
public class RecoverAdmin extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(AdminService.recover(admin_id, current_user, Util.getCurrentTime()));
    }
