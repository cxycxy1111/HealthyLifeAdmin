...
@WebServlet(name = "DeleteTip",urlPatterns = "/tip/delete")
public class DeleteTip extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session,
        ...
        out.append(tipService.delete(id,current_user,Util.getCurrentTime(),0));
    }
