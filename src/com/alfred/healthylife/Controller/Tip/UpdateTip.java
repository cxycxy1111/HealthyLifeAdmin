...
@WebServlet(name = "UpdateTip", urlPatterns = "/tip/update")
public class UpdateTip extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(tipService.update(id, title, summary, content, current_user, current_user_type, Util.getCurrentTime()));
    }
