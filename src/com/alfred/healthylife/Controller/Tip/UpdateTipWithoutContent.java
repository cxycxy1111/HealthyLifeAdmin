...
@WebServlet(name = "UpdateTipWithoutContent", urlPatterns = "/tip/updateWithoutContent")
public class UpdateTipWithoutContent extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session
        ...
        out.append(tipService.update(id, title, summary, current_user, current_user_type, Util.getCurrentTime()));
    }
